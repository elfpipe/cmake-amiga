...
struct Clib4IFace {
    ...
    void *h1; // (* ftello64) (FILE *stream);                                                                                                            /* 1884 */
    void *h2; // (* fseeko64) (FILE *stream, _off64_t, int);                                                                                             /* 1888 */
    void *h3; //int (* fgetpos64) (FILE *stream, _fpos64_t *pos);                                                                                                /* 1892 */
    void *h4; //int (* fsetpos64) (FILE *stream, _fpos64_t *pos);                                                                                                /* 1896 */
    ...
    void *h5; //int (* ftruncate64) (int file_descriptor, _off64_t length);                                                                                      /* 3012 */
    void *h6; //int (* truncate64) (const char *path_name, _off64_t length);                                                                                     /* 3016 */
    void *h7; //off64_t (* lseek64) (int fd, off64_t offset, int whence);                                                                                        /* 3020 */
    ...
    void *h8; //ssize_t (* pread64) (int fd, void *buf, size_t nbytes, off64_t offset);                                                                          /* 3304 */
    void *h9; //ssize_t (* pwrite64) (int fd, const void *buf, size_t nbytes, off64_t offset);                                                                   /* 3308 */
